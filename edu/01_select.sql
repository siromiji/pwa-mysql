...
-- 입사일이 20250101이후거나, 20000101이전이고 , 이미 퇴사한 직원
...
FROM employees
WHERE
	emp_id BETWEEN emp_id 10000 AND 10010	
;
...
-- 현재 받고있는 급여중 사원의 연봉 상위 5명을 조회해주세요
SELECT *
FROM salaries
WHERE 
	end_at IS NULL
